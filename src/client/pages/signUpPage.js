          ...
          <div className="col-md-6 align-self-center">
            <div className="row m-0">
              ...
              <div className="col-md-7 my-5 my-md-0">
                <h2 className="font-weight-bolder spysr-color mb-5 mt-1">Don't Miss Any Deal </h2>
                <SignUpFormUser user={{ email: '', firstName: '', lastName: '' }} />
                <div className="text-center mt-4">
                  <a id="sign-up-text" className="text-muted font-14" href="/login" target="_self">
