...
class PlatformUtils {
	...
	static deviceType(userAgent) {
		let a = userAgent || PlatformUtils.ua;
		if (!a && this.canUseDOM()) {
		...
		if (regex1.test(a) || regex2.test(a.substr(0, 4))) {
	...
	static isDesktop() {
		return PlatformUtils.deviceType() === DEVICE_TYPE.DESKTOP;
	}
